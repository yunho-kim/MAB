    ...
    def focus_cpu_assign(self,  new_cpu_assign, focus_time: int) -> bool:
        ...
        for fuzzer in run_fuzzers:
            ...
            while focusRemainTime > 0 :
                ...
                logger.info(f'main 501 - focus round : {focusRound}end result - fuzzer : {fuzzer}, previousBitmap : {previousBitmap}, currentBitmap : {currentBitmap}, previousBug : {previousBug}, currentBug : {currentBug}, focusSuccess : {focusSuccess}, focusFail : {focusFail}, fuzzer success :  {self.tsFuzzers[fuzzer].S}, fuzzer fail : {self.tsFuzzers[fuzzer].F},fuzzer stack : {self.tsFuzzers[fuzzer].stack}, focusThreshold : {focusThreshold}')
